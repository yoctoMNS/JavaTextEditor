...
- **Markdownビューア**: `.md`/`.markdown`ファイルは通常どおり生ソースを編集でき、`:view`コマンドで見出し・リスト・引用等を読みやすく整形した閲覧ビューに切り替え、`:mark`でソースへ戻せる（詳細は [docs/manual/12-markdown-viewer.md](docs/manual/12-markdown-viewer.md)）
