...
| クラス | 場所 | 役割 |
|---|---|---|
| `JdkClassIndex` | `src/dev/vimacs/analysis/JdkClassIndex.java` | jrt:/ 走査・クラス名→FQN マップ構築・Class<?> ロード |
| `JdkTypeInfo` | `src/dev/vimacs/analysis/JdkTypeInfo.java` | リフレクションによるクラス情報 (kind/methods/fields) |
...
`test/dev/vimacs/analysis/JdkClassIndexTest.java` に 18 テスト。
