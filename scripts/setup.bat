...
rem Font selectable via :font 1 (the default :font 0 is MiscFixedBold9x15.java,
rem a bitmap embedded directly in source, so it needs no download). Distributed
rem under SIL OFL 1.1. Downloaded at setup time into lib\fonts\ instead of being
rem committed, since lib\ is gitignored the same way as src.zip/openjdk-native above.
