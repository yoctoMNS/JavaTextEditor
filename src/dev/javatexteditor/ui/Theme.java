...
public enum Theme {
    DARK_MONO(
        ...
        new Color(0xE6, 0xE6, 0xE6),  // 文字列
        new Color(0xE6, 0xE6, 0xE6),  // コメント
        new Color(0xE6, 0xE6, 0xE6),  // 数値
        new Color(0xE6, 0xE6, 0xE6),  // プリプロセッサ/マクロ
        new Color(0xE6, 0xE6, 0xE6),  // 記号
        new Color(0xE6, 0xE6, 0xE6)   // 演算子
    ),
    BEIGE_MONO(
        true,
