...
public enum Theme {
    DARK_MONO(
        ...
        new Color(0xFB, 0xFB, 0xFB),  // 通常文字（少し明るい灰色）
        new Color(0xFB, 0xFB, 0xFB),
        new Color(0xFF, 0xFF, 0xFF),  // キーワード（明るい白）
        new Color(0xFF, 0xFF, 0xFF),  // 型名/クラス名（明るい白）
        new Color(0xFB, 0xFB, 0xFB),  // 文字列
        new Color(0xFB, 0xFB, 0xFB),  // コメント
        new Color(0xFB, 0xFB, 0xFB),  // 数値
        new Color(0xFB, 0xFB, 0xFB),  // プリプロセッサ/マクロ
        new Color(0xFB, 0xFB, 0xFB),  // 記号
        new Color(0xFB, 0xFB, 0xFB)   // 演算子
    ),
    BEIGE_MONO(
        true,
