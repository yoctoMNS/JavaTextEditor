...
このチュートリアルは全15レッスンです。前半（1〜10）は Vim 標準の操作、
後半（11〜14）はこのエディタ独自の機能、最後（15）は困ったときの対処法
をまとめています。すべての機能の詳細な説明は docs/manual/ にもあります。
...
==============================================================================
レッスン 11: このエディタ独自の機能（1） — 移動・効率化キー
==============================================================================
...
==============================================================================
レッスン 12: このエディタ独自の機能（2） — Java編集支援
==============================================================================
...
.java のファイルを開いているときに特に役立つ機能です。
  ...
  Ctrl+Shift+O  未使用の import 文を一括削除する（:oi コマンドも同じ）
...
==============================================================================
レッスン 13: このエディタ独自の機能（3） — プロジェクト全体を扱う機能
==============================================================================
...
:grep・\\f・\\g・gr（レッスン12）には「bang（!）付き」の全ファイル検索版
...
CPU/GPU温度・メモリ使用率（例: "CPU 45°C | GPU N/A | MEM 62%"）・
歩くキャラクターのアニメーションが表示されています（アクティブな
画面だけに表示されます）。温度センサーが無い環境では自動的に N/A に
なります。コンパイルエラーがある場合はエラー・警告の件数もここに
表示されます。
