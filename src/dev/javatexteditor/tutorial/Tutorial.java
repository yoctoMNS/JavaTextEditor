...
このチュートリアルは全18レッスンです。前半（1〜13）は Vim 標準の操作
（置換コマンド・マクロ・大文字小文字変換を含む）、中盤（14〜17）は
このエディタ独自の機能、最後（18）は困ったときの対処法をまとめて
います。すべての機能の詳細な
...
==============================================================================
レッスン 16: このエディタ独自の機能（3） — プロジェクト全体を扱う機能
==============================================================================
...
CPU/GPU使用率・メモリ使用率（例: "CPU 12% | GPU N/A | MEM 62%"）・
歩くキャラクターのアニメーションが表示されています（アクティブな
画面だけに表示されます）。GPU使用率はNVIDIA環境以外では自動的に N/A に
